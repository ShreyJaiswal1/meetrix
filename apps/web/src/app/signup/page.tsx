    ...
    <div className="min-h-screen flex" style={{ background: 'var(--bg)' }}>
      ...
      >
        <div
          ...
          style={{ background: 'radial-gradient(circle, var(--accent) 0%, transparent 70%)', top: '-80px', left: '-100px' }}
        />
        <div
          className="absolute w-[350px] h-[350px] rounded-full opacity-20"
          style={{ background: 'radial-gradient(circle, var(--secondary) 0%, transparent 70%)', bottom: '-60px', right: '20px' }}
        />
        ...
        <div className="relative z-10 px-16 max-w-lg">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            ...
            <p className="text-lg mb-8" style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.7 }}>
              Join thousands of students and teachers already using Meetrix to create seamless
              virtual classrooms.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { num: '∞', label: 'Unlimited classes' },
                { num: '🔒', label: 'Secure by default' },
                { num: '📱', label: 'Mobile ready' },
              ].map((stat, i) => (
                <motion.div
                  key={i}
                ...
                >
                  <div className="text-xl font-bold" style={{ color: 'var(--accent)' }}>{stat.num}</div>
        ...
        >
          ...
          <div className="glass-card p-8">
            <div className="mb-6">
              ...
              <p className="text-sm" style={{ color: 'var(--text-2)' }}>Start your learning journey today</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    style={{ background: 'var(--bg)', borderColor: 'var(--border)', color: 'var(--text-1)' }}
                  />
                  <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3.5 top-1/2 -translate-y-1/2 cursor-pointer" style={{ color: 'var(--text-3)' }}>
            ...
            <p className="text-center text-sm mt-6" style={{ color: 'var(--text-2)' }}>
              ...
              <Link href="/login" className="font-semibold" style={{ color: 'var(--secondary)' }}>Sign in</Link>
            </p>
          </div>
